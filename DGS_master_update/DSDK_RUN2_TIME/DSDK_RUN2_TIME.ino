...
void loop()
{
  ...
  Serial.print(mySensor1.getTime('s')); //default is 's' for time in seconds, you can use 'm' for time in minutes 
  Serial.print(", ");
  Serial.print(mySensor2.getTime('s')); 
  
  Serial.print(" id 1: ");
  Serial.print(mySensor1.getId('i')); //still don't work :(
  Serial.print(", 2: ");
  Serial.print(mySensor1.getId('i'));
  
  Serial.print(", Concentration = ");
  Serial.print(mySensor1.getConc('c'));     //default is 'p' for temperature compensated ppb, any other cahracter for raw counts
  Serial.print(", ");
  Serial.print(mySensor2.getConc('c'));

  Serial.print(", Average Temperature = ");

  Serial.print((mySensor1.getTemp('c') + mySensor2.getTemp('c')) / 2); //'F' or 'C' for units of temperature, default is 'C', any other cahracter for raw counts

  Serial.print(", Average Humidity = ");

  Serial.println((mySensor1.getRh('c') + mySensor2.getRh('c')) / 2);   //default is 'r' for %Rh, any other character for raw counts
