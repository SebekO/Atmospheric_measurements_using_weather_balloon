...
long DGS::getTime(char s)
{
  if (s == 's') return ((dataArray[7]*86400)+(dataArray[8]*3600)+(dataArray[9]*60)+(dataArray[10]));
  else return ((dataArray[7]*1440)+(dataArray[8]*60)+(dataArray[9])+(dataArray[10]/60));
}
long DGS::getId(char i)
{
  if (i == 'i') return dataArray[0];
  else return dataArray[0];
}
